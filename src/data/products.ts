...
export const testimonials = [
  {
    ...
    name: 'Priya Sharma',
    location: 'Mumbai',
    text: 'JessAura cotton kurtis are my absolute daily staple for work! The fabric is so soft, breathable, and holds up incredibly well after multiple washes.',
    rating: 5,
  ...
  },
  {
    ...
    name: 'Arjun Mehta',
    location: 'Delhi',
    text: 'Finding good casual short kurtas for men used to be tough. JessAura linen short kurtas fit like a dream with jeans. Highly recommended!',
    rating: 5,
